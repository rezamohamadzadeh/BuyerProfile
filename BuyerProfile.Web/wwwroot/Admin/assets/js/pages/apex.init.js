if ($("#line_chart_datalabel").length) {
    var options = {
        ...
        ,
        series: [{
            name: "Leads - 2018", data: [26, 24, 32, 36, 33, 31, 33]
        }
            ,
        {
            name: "Sales - 2018", data: [14, 11, 16, 12, 17, 13, 12]
        }
        ],
        title: {
            text: ".", align: "left"
...
if ($("#line_chart_dashed").length) {
    options = {
        ...
        ,
        stroke: {
            width: [3, 4, 3], curve: "straight", dashArray: [0, 8, 5]
        }
        ,
        series: [{
        ...
        title: {
            text: "Page Statistics", align: "left"
        }
        ,
        markers: {
            size: 0,
...
if ($("#spline_area").length) {
    options = {
        ...
        colors: ["#eff2f7",
            "#3051d3"],
        xaxis: {
            type: "datetime", categories: ["2018-09-19T00:00:00", "2018-09-19T01:30:00", "2018-09-19T02:30:00", "2018-09-19T03:30:00", "2018-09-19T04:30:00", "2018-09-19T05:30:00", "2018-09-19T06:30:00"]
        }
        ,
        grid: {
            borderColor: "#f1f1f1"
...
if ($("#column_chart").length) {
    options = {
        ...
        plotOptions: {
            bar: {
                horizontal: !1, columnWidth: "45%", endingShape: "rounded"
            }
        }
        ,
        dataLabels: {
...
if ($("#column_chart_datalabel").length) {
    options = {
        ...
        dataLabels: {
            ...
            offsetY: -20,
            style: {
                fontSize: "12px", colors: ["#00a7e1"]
            }
        }
        ,
        series: [{
            name: "Inflation", data: [2.5, 3.2, 5, 10.1, 4.2, 3.8, 3, 2.4, 4, 1.2, 3.5, .8]
        }
        ],
        colors: ["#0db4d6"],
        grid: {
...
if ($("#pie_chart").length) {
    options = {
        ...
        colors: ["#3051d3",
            ...
            "#eff2f7"],
        legend: {
            show: !0, position: "bottom", horizontalAlign: "center", verticalAlign: "middle", floating: !1, fontSize: "14px", offsetX: 0, offsetY: -10
        }
        ,
        responsive: [{
            breakpoint: 600,
